...
const queries: AdminQueries = {
  ...
  getIntelligenceOverview: async () => ({
    fixturesDiscovered: 0, competitionMapped: 0, teamsResolved: 0,
    modelSupported: 0, forecastGenerated: 0, oddsAvailable: 0,
    decisionEvaluated: 0, edge: 0, watch: 0, noBet: 0,
    waitForLineup: 0, insufficientData: 0, blockers: {},
    eventsAwaitingResult: 0, finalResultsReceived: 0,
    settlementsPending: 0, settlementsCompleted: 0,
    resultIngestionFailures: 0, unsettledActionableDecisions: 0,
    lastSuccessfulResultSync: null, lastSettlementRun: null, modelHealth: [],
  }),
};
