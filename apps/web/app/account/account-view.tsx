 ...
 *
 * Identity, plan and entitlements are the customer's own and never appear in
 * the shell: it is one static file served to everyone, so anything private
 * baked into it would belong to whoever loaded it last. All of it arrives
 * here, per session, from `/api/v1/customer/context`.
 */
