...
| Deployment | Note |
| --- | --- |
| `dpl_2KKg9NjxHCeK123N3zoQKZFUY8Y8` | **Current.** FT Over/Under 2.5 customer-facing surfacing: Match Intelligence "Other markets" card, History label fix (OVER/UNDER were rendering as "—"), Today/EDGE "Also EDGE" indicator (code `0c110f0`). Deployed 2026-09-10 18:06 EEST. Verified: health `LIVE`/`DATABASE`, ten routes 200, seven security headers, `/el` 4376 Greek words, zero synthetic markers. |
