...
export const messages = {
  ...
  adminSyntheticPhase: "Live production data",

  adminOverviewKicker: "Platform operations",
  adminOverviewTitle: "Traceability console.",
  adminOverviewBody:
    "Provider-sourced intelligence, governed from source run through to the customer result. Historical synthetic seed data remains visible and is labelled as such.",
  adminRecentRuns: "Recent provider runs",
  adminRunsVisible: "Latest visible page",
  adminDataPolicy: "Data policy",
  adminDataPolicyValue: "Provenance tracked on every row",
...
const greek: Readonly<Record<MessageKey, string>> = {
  ...
  adminSyntheticPhase: "Πραγματικά δεδομένα παραγωγής",

  adminOverviewKicker: "Λειτουργία πλατφόρμας",
  adminOverviewTitle: "Κονσόλα ιχνηλασιμότητας.",
  adminOverviewBody:
    "Δεδομένα από πάροχο, με έλεγχο από την εκτέλεση μέχρι το αποτέλεσμα που βλέπει ο πελάτης. Τα ιστορικά συνθετικά δεδομένα παραμένουν ορατά και επισημαίνονται ως τέτοια.",
  adminRecentRuns: "Πρόσφατες εκτελέσεις παρόχων",
  adminRunsVisible: "Τελευταία σελίδα",
  adminDataPolicy: "Πολιτική δεδομένων",
  adminDataPolicyValue: "Καταγραφή προέλευσης σε κάθε εγγραφή",
