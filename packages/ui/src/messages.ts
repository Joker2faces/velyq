...
export const messages = {
  ...
  todayWatchCount: "Worth watching",
  ...
  matchAutopsyClosingOdds: "Closing price",
  matchAutopsyDecidedAt: "Decided",
  matchAutopsyImpliedProbability: "Market implied (at decision)",
  matchAutopsyMinimumOdds: "Minimum acceptable (at decision)",
  ...
  adminNavLiveIngestion: "Live ingestion",
  adminNavReplayProvenance: "Replay provenance",
  adminLiveRunsMetric: "Live ingestion runs",
  adminRecentLiveRuns: "Recent live ingestion runs",
  adminOpenOperations: "Open operations",
  adminLiveIngestionTileBody: "Scheduler health and provider work",
  adminReplayProvenanceTileBody:
    "Deterministic fixture and normalization traces",
  adminLiveKicker: "OPERATIONS / LIVE PROVIDER",
  adminLiveTitle: "Live ingestion runs",
  adminLiveBody:
    "Scheduler and manual polls from provider ingestion. A completed zero-call run is healthy only when no provider work was due.",
  adminLiveCaption: "Live provider ingestion runs",
  adminColumnProviderTrigger: "Provider / trigger",
  adminColumnHealthStatus: "Health / status",
  adminColumnProviderCalls: "Provider calls",
  adminColumnAttemptsWrites: "Attempts → writes",
  adminColumnSkipsErrors: "Skips / errors",
  adminColumnStartedFinished: "Started / finished",
  adminDiagnose: "Diagnose",
  adminStatusAndResult: "{status} · result {result}",
  adminPhaseAttemptsWrites: "{phase} {attempts} → {written}",
  adminResultsAttemptsWrites:
    "Results {attempts} → {written} · settlements {settlements}",
  adminSkipsErrorsCounts: "{skips} / {errors}",
  adminLiveEmptyTitle: "No live ingestion runs recorded",
  adminLiveEmptyBody:
    "Replay provenance does not establish scheduler health. Check the scheduler target if this remains empty.",
  adminReplayPrompt: "Looking for fixture replays?",
  adminOpenReplay: "Open replay provenance",
  ...
  adminRunSummaryAria: "Run summary",
  adminHealthLabel: "Health",
  adminStatusLabel: "Status",
  adminResultOutcomeLabel: "Result outcome",
  adminTriggerLabel: "Trigger",
  adminProviderCallsLabel: "Provider calls",
  adminStartedLabel: "Started",
  adminFinishedLabel: "Finished",
  adminQuotaDayLabel: "Quota day",
  adminQuotaStartLabel: "Quota state at start",
  adminQuotaEndLabel: "Quota state at end",
  adminQuotaRemainingLabel: "Quota remaining",
  adminQuotaPolicyLabel: "Quota policy",
  adminHealthAria: "Run health: {health}",
  adminNoWorkDueTitle: "No provider work was due",
  adminNoWorkDueBody:
    "This completed scheduler wake-up is healthy. Zero provider calls means no discovery, odds, lineup, or result request was due.",
  adminAttemptsWritesTitle: "Attempts and writes",
  adminFixturesLabel: "Fixtures",
  adminOddsLabel: "Odds",
  adminLineupsLabel: "Lineups",
  adminResultsLabel: "Results",
  adminWrittenCount: "{count} written",
  adminReceivedDates: "{received} received · dates {dates}",
  adminDatesNone: "none",
  adminAttemptsWritten: "{attempts} attempts · {written} written",
  adminCandidatesReceivedExtra:
    "{candidates} candidates · {received} received · {extra}",
  adminDuplicatesCount: "Duplicates {count}",
  adminOfficialDuplicates: "Official {official} · duplicates {duplicates}",
  adminSettlementsDuplicates:
    "Settlements {settlements} · duplicates {duplicates}",
  adminSkipsErrorsAria: "Skips and errors",
  adminSkipsByReason: "Skips by reason",
  adminErrorsByReason: "Errors by reason",
  adminNone: "None",
  adminRunHealthRunning: "Running",
  adminRunHealthHealthyIdle: "Healthy idle",
  adminRunHealthHealthyActive: "Healthy active",
  adminRunHealthCompletedWithErrors: "Completed with errors",
  adminRunHealthQuotaBlocked: "Quota blocked",
  adminRunHealthBudgetBlocked: "Budget blocked",
  adminRunHealthWorkBlocked: "Due work blocked",
  adminRunHealthFailed: "Failed",
  adminRunStatusRunning: "Running",
  adminRunStatusCompleted: "Completed",
  adminRunStatusFailed: "Failed",
  adminResultNotAttempted: "Not attempted",
  adminResultSucceeded: "Succeeded",
  adminResultFailed: "Failed",
  adminTriggerScheduler: "Scheduler",
  adminTriggerManual: "Manual",
  adminQuotaHealthy: "Healthy",
  adminQuotaConserve: "Conserve",
  adminQuotaCritical: "Critical",
  adminQuotaExhausted: "Exhausted",
  adminQuotaUnknown: "Unknown",
  adminReplayKicker: "TRACE / REPLAY",
  adminReplayTitle: "Replay provenance",
  adminReplayBody:
    "Deterministic fixture replay identity, hashes, and normalization counts. These records do not represent live scheduler health.",
  adminReplayCaption: "Replay provenance runs",
  adminReplayDetailKicker: "TRACE / REPLAY PROVENANCE",
  adminAllReplayRuns: "All replay provenance",
  ...
  riskFlagStaleMarket: "Price is stale",
  riskFlagAgingMarket: "Price is ageing",
  riskFlagLowMarketCoverage: "Few bookmakers quoting this market",
  riskFlagHighBookmakerDispersion: "Bookmakers disagree on this price",
  riskFlagWaitingForLineup: "Waiting on the starting lineup",
  riskFlagModelExperimental: "Experimental model",
  riskFlagIdentityUncertain: "Team/competition identity uncertain",
  riskFlagInsufficientHistory: "Not enough price history yet",
  ...
  historyModel: "Model",
  historyModelVersionNone: "No model version",
  historyModelVersionMultiple: "{count} model versions",
...
const greek: Readonly<Record<MessageKey, string>> = {
  ...
  todayForecasts: "Προβλέψεις",
  todayWatchCount: "Αξίζουν παρακολούθηση",
  ...
  matchAutopsyDecidedAt: "Ημερομηνία απόφασης",
  matchAutopsyImpliedProbability: "Πιθανότητα αγοράς (κατά την απόφαση)",
  matchAutopsyMinimumOdds: "Ελάχιστη αποδεκτή (κατά την απόφαση)",
  matchDecision: "Απόφαση",
  ...
  adminNavLiveIngestion: "Ζωντανή εισαγωγή",
  adminNavReplayProvenance: "Προέλευση replay",
  adminLiveRunsMetric: "Εκτελέσεις ζωντανής εισαγωγής",
  adminRecentLiveRuns: "Πρόσφατες εκτελέσεις ζωντανής εισαγωγής",
  adminOpenOperations: "Άνοιγμα λειτουργίας",
  adminLiveIngestionTileBody: "Υγεία χρονοπρογραμματιστή και εργασία παρόχου",
  adminReplayProvenanceTileBody:
    "Ντετερμινιστικά ίχνη fixtures και κανονικοποίησης",
  adminLiveKicker: "ΛΕΙΤΟΥΡΓΙΑ / ΖΩΝΤΑΝΟΣ ΠΑΡΟΧΟΣ",
  adminLiveTitle: "Εκτελέσεις ζωντανής εισαγωγής",
  adminLiveBody:
    "Προγραμματισμένοι και χειροκίνητοι έλεγχοι εισαγωγής. Μια ολοκληρωμένη εκτέλεση χωρίς κλήσεις είναι υγιής μόνο όταν δεν υπήρχε εργασία για τον πάροχο.",
  adminLiveCaption: "Εκτελέσεις ζωντανής εισαγωγής παρόχου",
  adminColumnProviderTrigger: "Πάροχος / ενεργοποίηση",
  adminColumnHealthStatus: "Υγεία / κατάσταση",
  adminColumnProviderCalls: "Κλήσεις παρόχου",
  adminColumnAttemptsWrites: "Προσπάθειες → εγγραφές",
  adminColumnSkipsErrors: "Παραλείψεις / σφάλματα",
  adminColumnStartedFinished: "Έναρξη / λήξη",
  adminDiagnose: "Διάγνωση",
  adminStatusAndResult: "{status} · αποτέλεσμα {result}",
  adminPhaseAttemptsWrites:
    "{phase}: {attempts} προσπάθειες → {written} εγγραφές",
  adminResultsAttemptsWrites:
    "Αποτελέσματα {attempts} → {written} · διακανονισμοί {settlements}",
  adminSkipsErrorsCounts: "{skips} παραλείψεις / {errors} σφάλματα",
  adminLiveEmptyTitle: "Δεν καταγράφηκαν εκτελέσεις ζωντανής εισαγωγής",
  adminLiveEmptyBody:
    "Η προέλευση replay δεν αποδεικνύει την υγεία του χρονοπρογραμματιστή. Ελέγξτε τον στόχο του αν η λίστα παραμένει κενή.",
  adminReplayPrompt: "Ψάχνετε replay των fixtures;",
  adminOpenReplay: "Άνοιγμα προέλευσης replay",
  ...
  adminRunSummaryAria: "Σύνοψη εκτέλεσης",
  adminHealthLabel: "Υγεία",
  adminStatusLabel: "Κατάσταση",
  adminResultOutcomeLabel: "Έκβαση αποτελέσματος",
  adminTriggerLabel: "Ενεργοποίηση",
  adminProviderCallsLabel: "Κλήσεις παρόχου",
  adminStartedLabel: "Έναρξη",
  adminFinishedLabel: "Λήξη",
  adminQuotaDayLabel: "Ημέρα ορίου",
  adminQuotaStartLabel: "Κατάσταση ορίου στην έναρξη",
  adminQuotaEndLabel: "Κατάσταση ορίου στη λήξη",
  adminQuotaRemainingLabel: "Υπόλοιπο ορίου",
  adminQuotaPolicyLabel: "Πολιτική ορίου",
  adminHealthAria: "Υγεία εκτέλεσης: {health}",
  adminNoWorkDueTitle: "Δεν υπήρχε εργασία για τον πάροχο",
  adminNoWorkDueBody:
    "Αυτή η ολοκληρωμένη αφύπνιση του χρονοπρογραμματιστή είναι υγιής. Οι μηδενικές κλήσεις σημαίνουν ότι δεν έπρεπε να γίνει αίτημα ανακάλυψης, αποδόσεων, ενδεκάδων ή αποτελέσματος.",
  adminAttemptsWritesTitle: "Προσπάθειες και εγγραφές",
  adminFixturesLabel: "Αγώνες",
  adminOddsLabel: "Αποδόσεις",
  adminLineupsLabel: "Ενδεκάδες",
  adminResultsLabel: "Αποτελέσματα",
  adminWrittenCount: "{count} εγγραφές",
  adminReceivedDates: "{received} λήφθηκαν · ημερομηνίες {dates}",
  adminDatesNone: "καμία",
  adminAttemptsWritten: "{attempts} προσπάθειες · {written} εγγραφές",
  adminCandidatesReceivedExtra:
    "{candidates} υποψήφια · {received} λήφθηκαν · {extra}",
  adminDuplicatesCount: "Διπλότυπα {count}",
  adminOfficialDuplicates: "Επίσημες {official} · διπλότυπα {duplicates}",
  adminSettlementsDuplicates:
    "Διακανονισμοί {settlements} · διπλότυπα {duplicates}",
  adminSkipsErrorsAria: "Παραλείψεις και σφάλματα",
  adminSkipsByReason: "Παραλείψεις ανά αιτία",
  adminErrorsByReason: "Σφάλματα ανά αιτία",
  adminNone: "Κανένα",
  adminRunHealthRunning: "Σε εξέλιξη",
  adminRunHealthHealthyIdle: "Υγιής αδράνεια",
  adminRunHealthHealthyActive: "Υγιής ενεργή εκτέλεση",
  adminRunHealthCompletedWithErrors: "Ολοκληρώθηκε με σφάλματα",
  adminRunHealthQuotaBlocked: "Μπλοκαρισμένη από όριο κλήσεων",
  adminRunHealthBudgetBlocked: "Μπλοκαρισμένη από προϋπολογισμό",
  adminRunHealthWorkBlocked: "Μπλοκαρισμένη εκκρεμής εργασία",
  adminRunHealthFailed: "Απέτυχε",
  adminRunStatusRunning: "Σε εξέλιξη",
  adminRunStatusCompleted: "Ολοκληρώθηκε",
  adminRunStatusFailed: "Απέτυχε",
  adminResultNotAttempted: "Δεν επιχειρήθηκε",
  adminResultSucceeded: "Επιτυχία",
  adminResultFailed: "Αποτυχία",
  adminTriggerScheduler: "Χρονοπρογραμματιστής",
  adminTriggerManual: "Χειροκίνητα",
  adminQuotaHealthy: "Υγιές",
  adminQuotaConserve: "Εξοικονόμηση",
  adminQuotaCritical: "Κρίσιμο",
  adminQuotaExhausted: "Εξαντλημένο",
  adminQuotaUnknown: "Άγνωστο",
  adminReplayKicker: "ΙΧΝΟΣ / REPLAY",
  adminReplayTitle: "Προέλευση replay",
  adminReplayBody:
    "Ντετερμινιστική ταυτότητα replay fixture, hashes και μετρήσεις κανονικοποίησης. Αυτές οι εγγραφές δεν αντιπροσωπεύουν την υγεία του ζωντανού χρονοπρογραμματιστή.",
  adminReplayCaption: "Εκτελέσεις προέλευσης replay",
  adminReplayDetailKicker: "ΙΧΝΟΣ / ΠΡΟΕΛΕΥΣΗ REPLAY",
  adminAllReplayRuns: "Όλη η προέλευση replay",
  ...
  historyModelVersionNone: "Δεν υπάρχει έκδοση μοντέλου",
  historyModelVersionMultiple: "{count} εκδόσεις μοντέλου",
